...
7. Utilize model to evaluate current young players in the NHL. Identify possible players who have strong potential to become a start as well as players who it may be time for teams to begin allocating resources elsewhere
...
Additionally, I'll need to get the draft results for previous seasons to help me identify top-tier players. I do not have this information yet, but I'm confident that it is readily available online somewhere. 

One "nice to have" item that may turn out to be interesting to analyze would be how player performance in other leagues may help predict future NHL performance of you players. for that to happen I would likely need to do some data mining of other league data and further understand [NHLe](https://www.nhlnumbers.com/2015/07/17/predicting-future-nhl-scoring-success-with-nhle-thresholds-related-factors) and how it may impact rankings