...
**Inclusion of Elite Prospects Draft Years and Ages:** After briefly looking through the elite prospects data that was included in the github link that you sent earlier this week, I believe that I can pretty easily tie draft dates and ages to these players by name and team. If that does not work for one reason or another, I also recently came across a player index list at [Natural Stat Trick](https://www.naturalstattrick.com/playerteams.php?stdoi=bio) that can easily be exported to .csv and provides all of the data needed as well
